...
**Plain js does not persist b/w renders && changing them do not cause re-render. In ref - ref do persist b/w renders(like states) but changing ref does not cause re-render(unlike state) **
